      ...
      <div class="modal-header grey-bg pt-5 pb-4">
        <div class=" employer-details" style="display: flex;flex-direction: row;justify-content: center;align-items: center;padding: 0px;gap: 10px;">
          ...
          <div class=" rating-info">
            ...
            <a href="javascript:;" class="action-popup-rating" data-user_id="3347">
              <div class="r-updated">
                <ul class="ratinglist list-unstyled small-text 11">
              ...
              <div class="reviews-number small-text"><i class="fa-solid fa-comment"></i> 9 Vurderinger</div>
            </a>
          </div>
        </div>
...
<div class="meesagesloading" id="profile" style="display: none;">
...
<script>
  $(document).ready(function() {
    ...
    // var close = $('#close');
    var containerLoading = $('.meesagesloading');
